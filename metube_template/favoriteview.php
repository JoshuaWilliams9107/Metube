...
<body style="padding:0;margin:0;">
	<ul>
      ...
      <li><a id="floatleft" class="active" href='./favoriteview.php'>Favorite playlist</a></li>
	...
	<?php 
		$check = "SELECT playlist_id FROM favorite_table WHERE username='".$_SESSION['username']."'";
	...
	<center style="padding-top:20px;">
        <?php $playlistinfo = mysql_fetch_row(mysql_query("SELECT * FROM playlist WHERE playlistid = '".$data[0]."'")); ?>
	...
	<center>
			...
			$rowSize=3;
			$playlistquery = mysql_query("SELECT * FROM playlist_to_media WHERE playlistid='".$data[0]."'");
